/*
  ...
  1. Tables
    - sales_leads: Stores lead information and status
    - sales_activities: Tracks all interactions with leads
    - sales_opportunities: Manages sales pipeline stages
    - sales_contacts: Stores additional contact information

  2. Security
    - Enables RLS on all tables
    - Creates policies for sales team access
*/
