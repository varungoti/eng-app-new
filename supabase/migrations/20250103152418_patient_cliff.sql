...
DROP POLICY IF EXISTS "students_view_policy" ON students;
DROP POLICY IF EXISTS "students_manage_policy" ON students;
...
CREATE POLICY "students_view_policy_v2"
...
CREATE POLICY "students_manage_policy_v2"
  ON students FOR ALL
  TO authenticated
  USING (
