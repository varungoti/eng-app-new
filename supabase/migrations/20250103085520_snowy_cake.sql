/*
  # Add Sales CRM Tables

  1. New Tables
    - sales_leads: Track potential customers
    - sales_activities: Log all sales interactions
    - sales_opportunities: Track deals in pipeline
    - sales_contacts: Store multiple contacts per lead
