...
-- Generated at: 2025-05-08T10:59:44.179Z
...
CREATE TABLE IF NOT EXISTS exercise_prompts (
  ...
  metadata ARRAY,
  lesson_id uuid,
  CONSTRAINT exercise_prompts_lesson_id_fkey FOREIGN KEY,
  ...
  CONSTRAINT exercise_prompts_voice_id_fkey FOREIGN KEY,
...
CREATE TABLE IF NOT EXISTS user_preferences (
  ...
  CONSTRAINT user_preferences_preferred_voice_id_fkey FOREIGN KEY,
...
CREATE TABLE IF NOT EXISTS user_schools (
  ...
  CONSTRAINT user_schools_school_id_fkey FOREIGN KEY,
...
CREATE TABLE IF NOT EXISTS school_grades (
  ...
  created_at timestamp with time zone DEFAULT now(),
  CONSTRAINT school_grades_grade_id_fkey FOREIGN KEY,
...
CREATE TABLE IF NOT EXISTS lessons (
  ...
  role text,
  metadata jsonb,
  CONSTRAINT lessons_duration_check CHECK,
  ...
  CONSTRAINT lessons_voice_id_fkey FOREIGN KEY,
...
CREATE TABLE IF NOT EXISTS voices (
  ...
  created_at timestamp with time zone DEFAULT now(),
  updated_at timestamp with time zone DEFAULT now(),
  CONSTRAINT voices_gender_check CHECK,
  CONSTRAINT voices_pkey PRIMARY KEY,
  CONSTRAINT voices_school_id_fkey FOREIGN KEY,
  CONSTRAINT 2200_91184_1_not_null CHECK,
  CONSTRAINT 2200_91184_2_not_null CHECK,
  CONSTRAINT 2200_91184_4_not_null CHECK,
  CONSTRAINT 2200_91184_5_not_null CHECK,
  CONSTRAINT 2200_91184_6_not_null CHECK,
  CONSTRAINT 2200_91184_8_not_null CHECK
);
...
CREATE TABLE IF NOT EXISTS voice_settings (
  ...
  pitch_adjustment double precision DEFAULT 1.0,
  speed_adjustment double precision DEFAULT 1.0,
  volume_adjustment double precision DEFAULT 1.0,
  effects jsonb DEFAULT '{}'::jsonb,
  created_at timestamp with time zone DEFAULT now(),
  updated_at timestamp with time zone DEFAULT now(),
  CONSTRAINT voice_settings_pkey PRIMARY KEY,
  CONSTRAINT voice_settings_voice_id_fkey FOREIGN KEY,
  CONSTRAINT voice_settings_voice_id_key UNIQUE,
  CONSTRAINT 2200_91226_1_not_null CHECK,
  CONSTRAINT 2200_91226_2_not_null CHECK
);

-- Table: voice_usage_logs
CREATE TABLE IF NOT EXISTS voice_usage_logs (
  ...
  created_at timestamp with time zone DEFAULT now(),
  CONSTRAINT voice_usage_logs_content_type_check CHECK,
  CONSTRAINT voice_usage_logs_pkey PRIMARY KEY,
  CONSTRAINT voice_usage_logs_user_id_fkey FOREIGN KEY,
  CONSTRAINT voice_usage_logs_voice_id_fkey FOREIGN KEY,
  CONSTRAINT 2200_91247_1_not_null CHECK,
  CONSTRAINT 2200_91247_2_not_null CHECK,
  CONSTRAINT 2200_91247_3_not_null CHECK,
  CONSTRAINT 2200_91247_4_not_null CHECK,
  CONSTRAINT 2200_91247_5_not_null CHECK
);
...
CREATE TABLE IF NOT EXISTS questions (
  ...
  sub_type text,
  original_id text,
  CONSTRAINT questions_duration_check CHECK,
  ...
  CONSTRAINT questions_voice_id_fkey FOREIGN KEY,
  ...
  CONSTRAINT 2200_50362_17_not_null CHECK
);
...
CREATE TABLE IF NOT EXISTS users (
  ...
  CONSTRAINT users_school_id_fkey FOREIGN KEY,
...
CREATE TABLE IF NOT EXISTS activities (
  ...
  CONSTRAINT activities_voice_id_fkey FOREIGN KEY,
  ...
  CONSTRAINT 2200_52772_16_not_null CHECK,
  CONSTRAINT 2200_52772_17_not_null CHECK
);
...
CREATE TABLE IF NOT EXISTS ai_generated_content (
  ...
  metadata jsonb NOT NULL DEFAULT '{"targetAge": [5, 12], "difficulty": "beginner", "languageSkills": [], "estimatedDuration": 0}'::jsonb,
  usage_stats jsonb NOT NULL DEFAULT '{"timesUsed": 0, "averageScore": 0, "studentFeedback": {"rating": 0, "comments": []}}'::jsonb,
  status text NOT NULL DEFAULT 'draft'::text,
  tags ARRAY DEFAULT ARRAY[]::text[],
  created_at timestamp with time zone DEFAULT now(),
  updated_at timestamp with time zone DEFAULT now(),
  last_used_at timestamp with time zone,
  CONSTRAINT ai_generated_content_content_type_check CHECK,
  CONSTRAINT ai_generated_content_pkey PRIMARY KEY,
  CONSTRAINT ai_generated_content_status_check CHECK,
  CONSTRAINT ai_generated_content_teacher_id_fkey FOREIGN KEY,
  CONSTRAINT 2200_87621_1_not_null CHECK,
  CONSTRAINT 2200_87621_2_not_null CHECK,
  CONSTRAINT 2200_87621_3_not_null CHECK,
  CONSTRAINT 2200_87621_4_not_null CHECK,
  CONSTRAINT 2200_87621_6_not_null CHECK,
  CONSTRAINT 2200_87621_7_not_null CHECK,
  CONSTRAINT 2200_87621_8_not_null CHECK,
  CONSTRAINT 2200_87621_9_not_null CHECK
);
...
CREATE TABLE IF NOT EXISTS student_ai_progress (
  ...
  student_id uuid NOT NULL,
  content_id uuid NOT NULL,
  progress jsonb NOT NULL DEFAULT '{"score": 0, "status": "not_started", "attempts": 0, "timeSpent": 0}'::jsonb,
  performance jsonb NOT NULL DEFAULT '{"speed": 0, "accuracy": 0, "strengths": [], "weaknesses": [], "consistency": 0}'::jsonb,
  feedback jsonb NOT NULL DEFAULT '{"teacherNotes": [], "aiSuggestions": []}'::jsonb,
  created_at timestamp with time zone DEFAULT now(),
  updated_at timestamp with time zone DEFAULT now(),
  completed_at timestamp with time zone,
  CONSTRAINT student_ai_progress_content_id_fkey FOREIGN KEY,
  CONSTRAINT student_ai_progress_pkey PRIMARY KEY,
  CONSTRAINT student_ai_progress_student_id_fkey FOREIGN KEY,
  CONSTRAINT 2200_87643_1_not_null CHECK,
  CONSTRAINT 2200_87643_2_not_null CHECK,
  CONSTRAINT 2200_87643_3_not_null CHECK,
  CONSTRAINT 2200_87643_4_not_null CHECK,
  CONSTRAINT 2200_87643_5_not_null CHECK,
  CONSTRAINT 2200_87643_6_not_null CHECK
);
...
CREATE TABLE IF NOT EXISTS ai_content_analytics (
  id uuid NOT NULL DEFAULT gen_random_uuid(),
  content_id uuid NOT NULL,
  metrics jsonb NOT NULL DEFAULT '{"averageScore": 0, "totalAttempts": 0, "completionRate": 0, "averageTimeSpent": 0, "difficultyRating": 0}'::jsonb,
  demographics jsonb NOT NULL DEFAULT '{"ageGroups": {}, "skillLevels": {}, "successRates": {}}'::jsonb,
  feedback jsonb NOT NULL DEFAULT '{"comments": [], "studentRatings": [], "teacherRatings": []}'::jsonb,
  created_at timestamp with time zone DEFAULT now(),
  updated_at timestamp with time zone DEFAULT now(),
  CONSTRAINT ai_content_analytics_content_id_fkey FOREIGN KEY,
  CONSTRAINT ai_content_analytics_pkey PRIMARY KEY,
  CONSTRAINT 2200_87666_1_not_null CHECK,
  CONSTRAINT 2200_87666_2_not_null CHECK,
  CONSTRAINT 2200_87666_3_not_null CHECK,
  CONSTRAINT 2200_87666_4_not_null CHECK,
  CONSTRAINT 2200_87666_5_not_null CHECK
);
...
CREATE TABLE IF NOT EXISTS ai_conversations (
  ...
  metadata jsonb NOT NULL DEFAULT '{"skillLevel": "beginner", "languageArea": "grammar"}'::jsonb,
  feedback jsonb NOT NULL DEFAULT '{"score": 0, "strengths": [], "areasToImprove": [], "recommendations": []}'::jsonb,
  created_at timestamp with time zone DEFAULT now(),
  updated_at timestamp with time zone DEFAULT now(),
  archived boolean DEFAULT false,
  CONSTRAINT ai_conversations_class_id_fkey FOREIGN KEY,
  CONSTRAINT ai_conversations_conversation_type_check CHECK,
  CONSTRAINT ai_conversations_pkey PRIMARY KEY,
  CONSTRAINT ai_conversations_student_id_fkey FOREIGN KEY,
  CONSTRAINT ai_conversations_teacher_id_fkey FOREIGN KEY,
  CONSTRAINT 2200_87592_1_not_null CHECK,
  CONSTRAINT 2200_87592_2_not_null CHECK,
  CONSTRAINT 2200_87592_5_not_null CHECK,
  CONSTRAINT 2200_87592_6_not_null CHECK,
  CONSTRAINT 2200_87592_7_not_null CHECK,
  CONSTRAINT 2200_87592_8_not_null CHECK
);
