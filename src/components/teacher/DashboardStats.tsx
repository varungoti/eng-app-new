...
const dashboardData = {
  ...
  studentPerformance: [
    ...
    { name: 'Chris Paul', class: 'Grade 1', performance: '79%', attendanceRate: '88%', lastCompletedLesson: 'Lesson 10', hoursSpent: '18' },
    { name: 'Sarah Wilson', class: 'Grade 2', performance: '85%', attendanceRate: '92%', lastCompletedLesson: 'Lesson 12', hoursSpent: '23' },
    { name: 'Michael Johnson', class: 'Grade 3', performance: '94%', attendanceRate: '95%', lastCompletedLesson: 'Lesson 8', hoursSpent: '21' },
    { name: 'David Wilson', class: 'Grade 1', performance: '80%', attendanceRate: '85%', lastCompletedLesson: 'Lesson 11', hoursSpent: '19' },
    { name: 'Daniel Johnson', class: 'Grade 2', performance: '87%', attendanceRate: '90%', lastCompletedLesson: 'Lesson 13', hoursSpent: '24' },
    { name: 'Lucy Wilson', class: 'Grade 3', performance: '88%', attendanceRate: '92%', lastCompletedLesson: 'Lesson 7', hoursSpent: '20' }
  ],
  lessonProgress: [
...
export default function DashboardStats() {
  const [selectedGrade, setSelectedGrade] = useState(dashboardData.classWiseProgress[0].class);

  // Get data for the selected grade
  const gradeData = dashboardData.classWiseProgress.find(
    (item) => item.class === selectedGrade
  );
  
  const COLORS = ['#8884d8', '#82ca9d', '#ffc658'];
  
  const grades = dashboardData.classWiseProgress.map(item => item.class);

  return (
    <div className="space-y-8">
      {/* Grade Selector */}
      <div className="flex items-center mb-6">
        <label htmlFor="grade-select" className="mr-4 text-lg font-semibold">Select Grade:</label>
        <select
          id="grade-select"
          name="grade-select"
     ...
     {/* Class-wise Progress */}
      ...
      <div>
        ...
        <div className="space-y-0 grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-4">
      ...
      <div>
        ...
        <div 
          role="list"
          aria-label="Student Performance List"
          className="space-y-0 grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4"
        > 
